...
import { FacebookIcon, Palette, InstagramIcon, LinkedinIcon, YoutubeIcon } from 'lucide-react';
...
const footerLinks: FooterSection[] = [
  {
    label: 'Services',
    links: [
      { title: 'Web Development', href: '#features' },
      { title: 'UI/UX Design', href: '#features' },
      { title: 'Brand Identity', href: '#features' },
      { title: 'SEO & Performance', href: '#features' },
    ],
  },
  {
    label: 'Company',
    links: [
      ...
      { title: 'Our Work', href: '#testimonials' },
      ...
      <div className="grid w-full gap-8 xl:grid-cols-3 xl:gap-8">
        <AnimatedContainer className="space-y-4">
          ...
          <p className="text-muted-foreground mt-8 text-sm md:mt-0">
            © {new Date().getFullYear()} Flinke. All rights reserved.
          </p>
        </AnimatedContainer>
